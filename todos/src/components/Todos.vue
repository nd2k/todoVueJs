<template>
    <section class="todoapp">
        <header class="header">
            <h1>Todos</h1>
            <input type="text" autofocus autocomplete="off" class="new-todo" placeholder="Ajouter une nouvelle tâche" v-model="newTodo" @keyup.enter="addTodo">
        </header>
        <div class="main">
        ...
        <footer class="footer" v-show="hasTodos">
            <span class="todo-count"><strong>{{ remaining }}</strong> Tâches à réaliser</span>
            <ul class="filters">
